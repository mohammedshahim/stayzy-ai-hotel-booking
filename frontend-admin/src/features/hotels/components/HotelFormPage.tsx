  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      if (isEditMode && id) {
        ...
        toast.success("Hotel created — now add photos and room types below");
    ...
    <div className="flex flex-col gap-6">
      ...
      <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as string)}>
        <TabsList className="w-fit">
          ...
          <TabsTrigger value="images" disabled={!isEditMode}>
            Images
          </TabsTrigger>
          <TabsTrigger value="room-types" disabled={!isEditMode}>
            Room Types
          </TabsTrigger>
        </TabsList>
        ...
        <form
          ...
          className="mt-4 flex flex-col gap-6 rounded-2xl border border-border-default bg-surface p-6"
        >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <Select
                  ...
                  onValueChange={(value) => updateField("starRating", Number(value))}
                >
        ...
        {isEditMode && id && (
          <>
            <TabsContent value="images" className="mt-4 rounded-2xl border border-border-default bg-surface p-6">
